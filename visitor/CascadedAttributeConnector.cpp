...
A3DStatus ColorMaterialsConnector::GetRGB(double adRGB[3])//, char& cInheritance = 0)
{
	...
	A3DGraphRgbColorData sA3DGraphRgbColorData = A3D_MAKE_DATA(A3DGraphRgbColorData);
															...
															double& dShininess)
{
	...
	A3DGraphMaterialData sMaterialData = A3D_MAKE_DATA(A3DGraphMaterialData);
	...
	{
		iRet = 0;
		A3DGraphRgbColorData sColorData = A3D_MAKE_DATA(A3DGraphRgbColorData);
