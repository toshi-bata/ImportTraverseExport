										 ...
										 double a_dParallelToScreenPMIScale)
{
	...
	A3DGraphRgbColorData sRgbColorData = A3D_MAKE_DATA(A3DGraphRgbColorData);
	A3DGraphStyleData sGraphStyleData = A3D_MAKE_DATA(A3DGraphStyleData);

	A3DGraphPictureData sPictureData = A3D_MAKE_DATA(A3DGraphPictureData);

	A3DFontKeyData sFontKeyData = A3D_MAKE_DATA(A3DFontKeyData);
