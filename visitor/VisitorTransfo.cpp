...
A3DTransfoConnector* A3DVisitorTransfo::GetTransfoConnectorFromManager(A3DEntity const * pEntity)
{
	if(m_psContainer)
	{
		...
		if (pVLIM)
		{
			A3DMiscEntityReferenceData sSERData = A3D_MAKE_DATA(A3DMiscEntityReferenceData);
			...
			{
				A3DRiCoordinateSystemData sCSysData = A3D_MAKE_DATA(A3DRiCoordinateSystemData);
...
A3DStatus A3DVisitorTransfo::visitEnter(const A3DRiConnector& sConnector)
{
	...
	{
		A3DRiCoordinateSystemData sA3DRiCoordinateSystemData = A3D_MAKE_DATA(A3DRiCoordinateSystemData);
																...
																A3DMiscCartesianTransformation** ppLocation)
{
	...
	{
		A3DAsmProductOccurrenceData sExternalDataData = A3D_MAKE_DATA(A3DAsmProductOccurrenceData);
	...
	{
		A3DAsmProductOccurrenceData sPrototypeData = A3D_MAKE_DATA(A3DAsmProductOccurrenceData);
...
A3DMiscTransformation* A3DVisitorTransfo::CreateTransfo( A3DMatrix4x4 const & rMatrix )
{
	...
	A3DMiscGeneralTransformationData sData = A3D_MAKE_DATA(A3DMiscGeneralTransformationData);
